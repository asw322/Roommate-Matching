    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            path={'/admin/locationpreference'}
            exact
            component={LocationpreferenceTablePage}
          />
          <Route
            path={'/admin/locationpreference/new'}
            exact
            component={LocationpreferenceFormPage}
          />
          <Route
            path={'/admin/locationpreference/:id/edit'}
            exact
            component={LocationpreferenceFormPage}
          />

          <Route
            path={'/admin/usersurvey'}
            exact
            component={UsersurveyTablePage}
          />
          <Route
            path={'/admin/usersurvey/new'}
            exact
            component={UsersurveyFormPage}
          />
          <Route
            path={'/admin/usersurvey/:id/edit'}
            exact
            component={UsersurveyFormPage}
          />
          ...
          <Route
            ...
            exact
            component={UserpreferenceTablePage}
          />
          <Route
            path={'/admin/userpreference/new'}
            exact
            component={UserpreferenceFormPage}
          />
          <Route
            path={'/admin/userpreference/:id/edit'}
            exact
            component={UserpreferenceFormPage}
          />

          <Route
            path={'/admin/userquestionweight'}
            exact
            component={UserquestionweightTablePage}
          />
          <Route
            path={'/admin/userquestionweight/new'}
            exact
            component={UserquestionweightFormPage}
          />
          <Route
            path={'/admin/userquestionweight/:id/edit'}
            exact
            component={UserquestionweightFormPage}
          />

          <Route
            path={'/admin/usermatches'}
            exact
            component={UsermatchesTablePage}
          />
          <Route
            path={'/admin/usermatches/new'}
            exact
            component={UsermatchesFormPage}
          />
          <Route
            path={'/admin/usermatches/:id/edit'}
            exact
            component={UsermatchesFormPage}
          />
        </Switch>
