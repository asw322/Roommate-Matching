...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/usermatches/autocomplete`, { params });
  return response.data;
}

const UsermatchesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.usermatches.hasPermissionToCreate,
});

export default connect(select)(UsermatchesSelectItem);
