...
router.post('/', async (req, res) => {
  await UserquestionweightService.create(
    req.body.data,
    req.currentUser,
    true,
    req.headers.referer,
...
router.put(
  ...
  wrapAsync(async (req, res) => {
    await UserquestionweightService.update(
      req.body.data,
      req.body.id,
      req.currentUser,
    );
...
router.get(
  '/',
  wrapAsync(async (req, res) => {
    const payload = await UserquestionweightDBApi.findAll(req.query);
...
router.get(
  '/:id',
  wrapAsync(async (req, res) => {
    const payload = await UserquestionweightDBApi.findBy({ id: req.params.id });
