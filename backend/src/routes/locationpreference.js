...
router.post('/', async (req, res) => {
    await LocationpreferenceService.create(req.body.data, req.currentUser, true, req.headers.referer);
    const payload = true;
...
router.put('/:id', wrapAsync(async (req, res) => {
  await LocationpreferenceService.update(req.body.data, req.body.id, req.currentUser);
  const payload = true;
  res.status(200).send(payload);
}));
