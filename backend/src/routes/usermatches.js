...
router.post('/', async (req, res) => {
  await UsermatchesService.create(
    req.body.data,
    req.currentUser,
    true,
    req.headers.referer,
...
router.put(
  ...
  wrapAsync(async (req, res) => {
    await UsermatchesService.update(
      req.body.data,
      req.body.id,
      req.currentUser,
    );
...
router.get(
  '/',
  wrapAsync(async (req, res) => {
    const payload = await UsermatchesDBApi.findAll(req.query);
...
router.get(
  '/:id',
  wrapAsync(async (req, res) => {
    const payload = await UsermatchesDBApi.findBy({ id: req.params.id });
